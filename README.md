...
```
cd existing_repo
git remote add origin https://gitlab.com/AlvaroCarbo/api-rest-videogames.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/AlvaroCarbo/api-rest-videogames/-/settings/integrations)
